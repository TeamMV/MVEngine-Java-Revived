...
public class SimpleOvalCollider implements Collider {

    private static final String name = SimpleOvalCollider.class.getSimpleName();
    private final float[] innerPolygonCoef, outerPolygonCoef;
    private final int maxIterations = 10;
    private Physics physics;

    public SimpleOvalCollider(Physics physics) {
