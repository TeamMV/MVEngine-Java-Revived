...
import dev.mv.engine.physics.shapes.Square;

public class SimpleRectangleCollider implements Collider {

    private static final String name = SimpleRectangleCollider.class.getSimpleName();
    private Physics physics;

    public SimpleRectangleCollider(Physics physics) {
